...
sk, pk = ECDSA_sv.key_gen()  # A publish pk for others to verify
...
forged_signature= ECDSA_sv.ECDSA_sign(message_for_forge, d)

######### C get signature forged by B and verify it with pk of A #########
if ECDSA_sv.ECDSA_verify(forged_signature, message_for_forge, pk) == 1:
